      ...
      <div className="card shadow bg-dark rounded">
        ...
        <div className="d-flex justify-content-center">
          <button
            ...
            onClick={() => (window.location.href = "https://www.linkedin.com/in/luis-david-flores-mart%C3%ADnez-aa2325228/")}
          >
          ...
          <button
            ...
            className="btn btn-outline-light rounded-circle mx-3 my-4"
            style={{ width: "50px", height: "50px" }}
            onClick={() => (window.location.href = "https://github.com/LuisFlores7247")}
          >
